...
public class UserExamPassController {
    ...
    private void ensureStartedSaved() {
        ...
        try {
            ...
            showError(e instanceof SQLException sqlException && userEvaluationService.isUserNotFound(sqlException)
                    ? UserEvaluationService.USER_NOT_FOUND_MESSAGE
                    : "Erreur création démarrage examen : " + e.getMessage());
        }
    }
    ...
    private void loadSubmissionState() {
        ...
        try {
            ...
            showError(userEvaluationService.isUserNotFound(e) ? UserEvaluationService.USER_NOT_FOUND_MESSAGE : "Erreur chargement état examen : " + e.getMessage());
        }
    }
    ...
    private void submitExamInternal(boolean automaticMode) throws Exception {
        ...
        try {
            ...
            showError(userEvaluationService.isUserNotFound(e) ? UserEvaluationService.USER_NOT_FOUND_MESSAGE : "Erreur soumission examen : " + e.getMessage());
            return;
        }
