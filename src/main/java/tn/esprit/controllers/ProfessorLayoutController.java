...
public class ProfessorLayoutController implements Initializable {
    ...
    private static ProfessorLayoutController instance;

    public static ProfessorLayoutController getInstance() { return instance; }
    ...
    public void showProfile() {
        loadContent("/fxml/ProfessorProfileContent.fxml");
        setActiveNav(null);
    }

    @FXML
    public void showSettings() {
        loadContent("/fxml/ProfessorSettingsContent.fxml");
        setActiveNav(null);
    }
    ...
    private void setActiveNav(Button active) {
        for (Button b : new Button[]{navHome, navCourses, navStudents}) {
