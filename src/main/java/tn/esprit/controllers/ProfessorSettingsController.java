...
public class ProfessorSettingsController implements Initializable {
    ...
    @FXML private Label linkedInStatus;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        String saved = LinkedInProfile.getUrl(u.getId());
        if (saved != null) linkedInField.setText(saved);
    ...
    public void handleSave() {
        ...
        try {
            ...
            String linkedIn = linkedInField.getText() == null ? "" : linkedInField.getText().trim();
            LinkedInProfile.setUrl(u.getId(), linkedIn);
