...
public class Report {
    ...
    public String toString() {
        return "Report{" +
                "id=" + id + ", " + "postId=" + postId + ", " + "replyId=" + replyId + ", " + "userId=" + userId + ", " + "reason=" + reason + ", " + "description=" + description + ", " + "status=" + status + ", " + "createdAt=" + createdAt + ", " + "reviewedAt=" + reviewedAt + ", " + "reviewedBy=" + reviewedBy +
                "}";
    }
}
