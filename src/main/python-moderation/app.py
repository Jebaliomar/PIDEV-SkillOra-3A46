...
# Use the multilingual model if you need French support.
# The model card says it is tested on:
# english, french, spanish, italian, portuguese, turkish, russian. :contentReference[oaicite:2]{index=2}
